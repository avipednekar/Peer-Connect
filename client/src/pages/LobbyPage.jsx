...
export default function LobbyPage({ onlineUsers, onCallFriend }) {
    ...
    const handleJoinExisting = () => {
        ...
        if (!id) return;
        // Support pasting full URL or just room ID
                        ...
                        <div className="glass p-6 animate-fade-in">
                            ...
                            {!createdRoomId ? (
                                <button
                                    ...
                                    className="w-full py-3.5 rounded-xl font-semibold text-white transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-accent-500/20"
